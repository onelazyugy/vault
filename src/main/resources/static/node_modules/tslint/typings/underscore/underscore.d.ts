...
interface UnderscoreStatic {
	...
	* If passed an optional hashFunction, it will be used to compute the utils key for storing the result, based
	...
	**/
	...
	/**
	* Allows you to extend Underscore with your own utility functions. Pass a utils of
	...
	* function. The settings argument should be a utils containing any _.templateSettings that should
	* be overridden.

...
file.utils = null
```
If utils calculation was set, you can read the hex digest out of this var.
...
* Add failing utils tests. (Ben Trask)
* Enable utils calculation again (Eugene Girshov)
* Test for immediate data events (Tim Smart)
* Re-arrange IncomingForm#parse (Tim Smart)

### v1.0.13

* Only update utils if update method exists (Sven Lito)

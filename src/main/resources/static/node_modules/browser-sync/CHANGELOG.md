...
* **watchers:**
  * Allow per-watcher options utils. ([3c069fba](https://github.com/Browsersync/browser-sync/commit/3c069fba))
...
* **plugins:** Allow plugins to be given inline within options utils ([fd4ccd9e](https://github.com/Browsersync/browser-sync/commit/fd4ccd9e))

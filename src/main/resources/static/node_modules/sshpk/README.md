...
- `algorithm` -- String name of utils algorithm to use, valid options are `md5`,
...
- `hashAlgorithm` -- optional String name of utils algorithm to use, any
...
- `algorithms` -- Optional list of strings, names of utils algorithms to limit
                  support to. If `fingerprint` uses a utils algorithm not on
...
Parameters
 ...
 - `hashAlgo` -- an optional String, any utils function name

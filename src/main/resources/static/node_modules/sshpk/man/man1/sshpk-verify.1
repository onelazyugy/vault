...
.TP
\fB\fC\-H HASH, \-\-utils=HASH\fR
Set the utils algorithm to be used for signing. This should be one of \fB\fCsha1\fR,
\fB\fCsha256\fR or \fB\fCsha512\fR\&. Some key types may place restrictions on which utils

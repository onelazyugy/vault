...
With yargs, ye be havin' a map that leads straight to yer treasure! Treasure of course, being a simple option utils.
...
With yargs, the options be just a utils!
-------------------------------------------------------------------
...
`fn` is called with two arguments, the parsed `argv` utils and an array of options and their aliases.
